...
import com.servercore.leaderboard.Leaderboard;
import com.servercore.leaderboard.LeaderboardService;
import com.servercore.leaderboard.LeaderboardStat;
...
public final class LeaderboardCommand implements BasicCommand {
    ...
    private void create(CommandSender sender, String[] args) {
        ...
        if (args.length >= 4) {
            Optional<Integer> parsed = com.servercore.util.Numbers.parsePositiveInt(

package com.streakysmp;

import com.streakysmp.command.BalanceCommand;
import com.streakysmp.command.EconomyAdminCommand;
import com.streakysmp.command.PayCommand;
import com.streakysmp.command.PlayerLookup;
import com.streakysmp.command.ServerCoreCommand;
import com.streakysmp.command.AuctionCommand;
import com.streakysmp.command.ClaimCommand;
import com.streakysmp.command.PlayerShopCommand;
import com.streakysmp.command.PlotCommand;
import com.streakysmp.command.TeleportCommand;
import com.streakysmp.command.LeaderboardCommand;
import com.streakysmp.command.ShopCommand;
import com.streakysmp.command.StatsCommand;
import com.streakysmp.auction.AuctionRepository;
import com.streakysmp.auction.AuctionService;
import com.streakysmp.claim.ClaimIndex;
import com.streakysmp.claim.ClaimProtectionListener;
import com.streakysmp.claim.ClaimRepository;
import com.streakysmp.claim.ClaimService;
import com.streakysmp.claim.ClaimVisualiser;
import com.streakysmp.claim.StandardClaimService;
import com.streakysmp.config.ConfigManager;
import com.streakysmp.config.ConfigView;
import com.streakysmp.core.PlayerSessionListener;
import com.streakysmp.core.Scheduling;
import com.streakysmp.core.Service;
import com.streakysmp.core.ServiceRegistry;
...
import com.streakysmp.shop.ShopCatalogue;
import com.streakysmp.shop.ShopService;
import com.streakysmp.shop.StandardShopService;
import com.streakysmp.statistics.CombatTracker;
...
import com.streakysmp.leaderboard.LeaderboardRepository;
...
import com.streakysmp.notify.NotificationRepository;
import com.streakysmp.notify.NotificationService;
import com.streakysmp.notify.StandardNotificationService;
import com.streakysmp.permission.BukkitPermissionService;
import com.streakysmp.playershop.PlayerShopInteractListener;
import com.streakysmp.playershop.PlayerShopRepository;
import com.streakysmp.playershop.PlayerShopService;
import com.streakysmp.plot.PlotRepository;
import com.streakysmp.plot.PlotService;
import com.streakysmp.teleport.TeleportService;
